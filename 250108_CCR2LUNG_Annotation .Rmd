...
celldata[which(celldata$anncluster == "02"), "anncluster"] = "02_Tumour"
...
celldata[which(celldata$anncluster == "05"), "anncluster"] = "05_Uncertain"
celldata[which(celldata$anncluster == "06"), "anncluster"] = "06_Dendritic cells"
...
celldata[which(celldata$anncluster == "09"), "anncluster"] = "09_Uncertain"
...
celldata[which(celldata$anncluster == "13"), "anncluster"] = "13_mix"
...
celldata[which(celldata$anncluster == "16"), "anncluster"] = "16_?"
celldata[which(celldata$anncluster == "17"), "anncluster"] = "17_Macrophages"
celldata[which(celldata$anncluster == "18"), "anncluster"] = "18_?"
celldata[which(celldata$anncluster == "19"), "anncluster"] = "19_Macrophages or mix"
celldata[which(celldata$anncluster == "20"), "anncluster"] = "20_Macrophages"
celldata[which(celldata$anncluster == "21"), "anncluster"] = "21_Macrophages?"
...
celldata[which(celldata$anncluster == "25"), "anncluster"] = "25_Macrophages"
...
celldata[which(celldata$anncluster == "28"), "anncluster"] = "28_T cel CD4"
celldata[which(celldata$anncluster == "29"), "anncluster"] = "29_Macrophages"
celldata[which(celldata$anncluster == "3"), "anncluster"] = "30_Fibroblasts"
celldata[which(celldata$anncluster == "31"), "anncluster"] = "31_mix"
...
annotate.cluster = function(clusterCol) {
  for (cluster in unique(clusterCol)) {
    newname = switch(cluster,
                     ...
                     "14" = "14_Tumour",
                     "15" = "15_Uncertain",
                     "16" = "16_Dendritic cells CD103",
                     "17" = "17_Dendritic cells",
                     "18A" = "18A_Macrophages",
                     "18B" = "18B_Tumour",
                     "19" = "19_Fibroblasts",
                     "20" = "20_Tumour",
...
celldata$anncluster = str_pad(celldata$kinv25, 2, side="left", pad="0")

celldata[celldata$MI_B220 >= 0.3, "anncluster"] = "33"  
celldata[celldata$MI_B220 >= 0.3 &
           celldata$MI_CollagenI >= 0.5, "anncluster"] = "34"
# # Split cluster 11 into T regs and CD 4 T Cells 
celldata[celldata$anncluster == "11" &
           celldata$MI_Foxp3 >= 0.4, "anncluster"] = "11A"
celldata[celldata$anncluster == "11", "anncluster"] = "11B"

# split cluster 1 and 7 to macrophages and tumour
celldata[celldata$anncluster == "01" &
           (celldata$MI_CD68 >= 0.35|celldata$MI_F480 >= 0.35), "anncluster"] = "01A" #mac
celldata[celldata$anncluster == "01", "anncluster"] = "01B"#tumour
# 07  mac and tumour and CD11c
celldata[celldata$anncluster == "07" &
          (celldata$MI_F480 >= 0.3|celldata$MI_CD68 >= 0.3), "anncluster"] = "07A"#mac
celldata[celldata$anncluster == "07", "anncluster"] = "07B"# tumour

celldata[celldata$anncluster == "18" &
          celldata$MI_F480 >= 0.2, "anncluster"] = "18A"#mac
celldata[celldata$anncluster == "18", "anncluster"] = "18B"# tumour

# split cluster 17 to DC and Tumour and CD11c

# celldata[celldata$anncluster == "17" & 
#            celldata$MI_MHCcII >= 0.3 &
#            celldata$MI_CD11c >= 0.3,"anncluster"] <- "17A"  # DC
# celldata[celldata$anncluster == "17", "anncluster"] = "17B"#Mac?
...
# # Split cluster 
# celldata[celldata$anncluster == "08" &
#            celldata$MI_F480 >= 0.25, "anncluster"] = "08A"
# celldata[celldata$anncluster == "08", "anncluster"] = "08B"
# celldata[celldata$anncluster == "22" &
#            celldata$MI_CD11c >= 0.2, "anncluster"] = "22A"
# celldata[celldata$anncluster == "22", "anncluster"] = "22B"

# celldata[celldata$anncluster == "09" &
#            celldata$MI_PancK >= 1, "anncluster"] = "09A"
# celldata[celldata$anncluster == "09", "anncluster"] = "09B"
...
annlevels = c("Tumour", "Fibroblasts", "Endothelium", 
           "T cell CD8", "T cell CD4", "Tregs","TCRgdt", "Dendritic cells",
...
```{r}
plot.scatter(celldata, "kinv25", 1, Xmarker = "CD44", Ymarker = "MHCII",dim=1.5)
plot.scatter(celldata, "kinv25", 1, Xmarker = "CD44", Ymarker = "CD24",dim=1.1)
plot.scatter(celldata, "kinv25", 1, Xmarker = "PVR", Ymarker = "F480",dim=1)
plot.scatter(celldata, "kinv25", 1, Xmarker = "PVR", Ymarker = "CD68",dim=1)
plot.scatter(celldata, "kinv25", 1, Xmarker = "PDL1", Ymarker = "F480",dim=1)
plot.scatter(celldata, "kinv25", 1, Xmarker = "PDL1", Ymarker = "CD68",dim=1)
plot.scatter(celldata, "kinv25", 1, Xmarker = "PVR", Ymarker = "CD68",dim=1)
plot.scatter(celldata, "kinv25", 1, Xmarker = "PVR", Ymarker = "F480",dim=1)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD44", Ymarker = "F480",dim=1.5)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD68", Ymarker = "CD44",dim=0.7)
plot.scatter(celldata, "kinv25", 4, Xmarker = "F480", Ymarker = "CD44",dim=0.7)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "CD44",dim=1.5)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "F480",dim=1)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "CD68",dim=1)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "CD206",dim=1.5)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "MHCcII",dim=1)
plot.scatter(celldata, "kinv25", 4, Xmarker = "MHCcII", Ymarker = "CD44",dim=1.5)
plot.scatter(celldata[celldata$ROI_ID=="01_MOC2_CCR2KO",], "kinv25", 3, Xmarker = "CD206", Ymarker = "aSMA",dim=1.5)
plot.scatter(celldata[celldata$ROI_ID=="05_MOC2_CCR2KO",], "kinv25", 3, Xmarker = "CD206", Ymarker = "aSMA",dim=1.5)
plot.scatter(celldata[celldata$ROI_ID=="03_MOC2_CCR2KO",], "kinv25", 3, Xmarker = "CD206", Ymarker = "aSMA",dim=1.5)
plot.scatter(celldata[celldata$ROI_ID=="06_MOC2_CCR2KO",], "kinv25", 3, Xmarker = "CD206", Ymarker = "aSMA",dim=1.5)
plot.scatter(celldata, "kinv25", 3, Xmarker = "aSMA", Ymarker = "CD206",dim=1.5)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "CD11b",dim=0.4)
plot.scatter(celldata, "kinv25", 4, Xmarker = "CD11b", Ymarker = "CD44",dim=0.5)
plot.scatter(celldata, "kinv25", 4, Xmarker = "LY6G", Ymarker = "CD11b",dim=0.5)
plot.scatter3(celldata, "kinv25", 4, Xmarker = "CD44", Ymarker = "CD11c","MHCcII",dim=2)
plot.scatter3(celldata, "kinv25", 4, Xmarker = "CD11c", Ymarker = "F480","MHCcII",dim=1)
plot.scatter(celldata, "kinv25", 7, Xmarker = "CD68", Ymarker = "F480",dim=1)
plot.scatter(celldata, "kinv25", 7, Xmarker = "CD68", Ymarker = "pS6",dim=0.7)
plot.scatter(celldata, "kinv25", 7, Xmarker = "CD68", Ymarker = "CD44",dim=0.7)
plot.scatter(celldata, "kinv25", 7, Xmarker = "CD68", Ymarker = "PVR",dim=0.7)
plot.scatter(celldata, "kinv25", 7, Xmarker = "CD11b", Ymarker = "CD11c",dim=1)
plot.scatter(celldata, "kinv25", 9, Xmarker = "aSMA", Ymarker = "CD44",dim=1)
plot.scatter(celldata, "kinv25", 10, Xmarker = "F480", Ymarker = "CD68",dim=1)
plot.scatter(celldata, "kinv25", 17, Xmarker = "CD11c", Ymarker = "CD44",dim=1.5)
plot.scatter(celldata, "kinv25", 17, Xmarker = "MHCcII", Ymarker = "CD44",dim=1.5)
plot.scatter(celldata, "kinv25", 17, Xmarker = "CD11c", Ymarker = "PVR",dim=1)
plot.scatter(celldata, "kinv25", 17, Xmarker = "CD11c", Ymarker = "pS6",dim=1)
plot.scatter(celldata, "kinv25", 17, Xmarker = "CD11c", Ymarker = "PDL1",dim=1)
plot.scatter(celldata, "kinv25", 17, Xmarker = "F480", Ymarker = "CD44",dim=1)
plot.scatter(celldata[celldata$ROI_ID=="08_MOC2_WT",], "kinv25", 17, Xmarker = "MHCcII", Ymarker = "CD11c",dim=2)
plot.scatter(celldata[celldata$ROI_ID=="09_MOC2_WT",], "kinv25", 17, Xmarker = "MHCcII", Ymarker = "CD11c",dim=2)
plot.scatter(celldata[celldata$ROI_ID=="10_MOC2_WT",], "kinv25", 17, Xmarker = "MHCcII", Ymarker = "CD11c",dim=2)
plot.scatter(celldata[celldata$ROI_ID!="07_MOC2_WT",], "kinv25", 17, Xmarker = "MHCcII", Ymarker = "CD11c",dim=2)
plot.scatter(celldata, "kinv25", 17, Xmarker = "MHCcII", Ymarker = "CD11c",dim=2)
plot.scatter(celldata, "kinv25", 18, Xmarker = "F480", Ymarker = "CD24",dim=0.5)
plot.scatter(celldata, "kinv25", 22, Xmarker = "PDL1", Ymarker = "CD44",dim=1)
plot.scatter(celldata, "kinv25", 23, Xmarker = "CD11c", Ymarker = "CD44",dim=0.7)
plot.scatter(celldata, "kinv25", 23, Xmarker = "MHCcII", Ymarker = "CD44",dim=1)
plot.scatter(celldata, "kinv25", 23, Xmarker = "MHCcII", Ymarker = "CD103",dim=0.7)
plot.scatter(celldata, "kinv25", 25, Xmarker = "F480", Ymarker = "EPCAM",dim=0.5)
plot.scatter(celldata, "kinv25", 21, Xmarker = "LY6G", Ymarker = "CD11b",dim=1.5)
plot.scatter(celldata, "kinv25", 32, Xmarker = "PancK", Ymarker = "aSMA",dim=3)
plot.scatter(celldata, "kinv25", 18, Xmarker = "CD68", Ymarker = "CD44",dim=1)
...
CellClusters
CellColumns =  c("MI_EPCAM","MI_PancK","MI_PVR","MI_casp3","MI_CD44","MI_PDL1","MI_Ki67","MI_pS6","MI_CD11b","MI_LY6G","MI_aSMA","MI_Vimentin","MI_MHCcII", "MI_F480", "MI_CD103", "MI_PDL1", "MI_CD86",  "MI_CD68", "MI_CD206",  "MI_CD11c","MI_Thy1_2", "MI_CD3", "MI_CD45", "MI_CD4", "MI_CD8", "MI_Foxp3","MI_B220",
 "MI_LAG3", "MI_PD1", "MI_TCRgd", "MI_TIM3","MI_CollagenI", "MI_PECAM")
CellCD= generate.UMAP(celldata = celldata, clusters = CellClusters,
                            markers = CellColumns, nsample = 20000,
                            filename = "241130CellCD.csv")
...
geom_point(data = celldata[which(celldata$MI_PancK>0.4),], size = 0.01, colour = "red") +
...
plot.clusteroverlay(celldata = celldata, ROIdata = imagemetadata,
                    factor = "kinv25", levels = unique(celldata$kinv25))
```
