...
if (F) {
  ...
  TCellMarkers_lineage = c("MI_CD3e", "MI_CD45", "MI_CD4", "MI_CD8a", "MI_Foxp3")
    TCellMarkers = c("MI_CD3e", "MI_CD45", "MI_CD4", "MI_CD8a", "MI_Foxp3","MI_PD1","MI_TIM3","MI_LAG3")
  print(TCellClusters)
...
set.seed(222)
  TCD = generate.UMAP(celldata = celldata, clusters = TCellClusters,
                      markers = TCellMarkers_lineage, nsample = 3000, filename = "250115TCD.csv")
set.seed(111)  
...
#geom_point(data = celldata[which(celldata$anncluster=="17A"),], size = 0.01, colour = "red") +
  ...
  # geom_point(data = celldata[which(celldata$annotation%in% c("T cell CD8", "T cell CD8","Tregs")),], size = 0.01, colour = "red") +
   geom_point(data = celldata[which(celldata$annotation=="T cell CD8"),], size = 0.01, colour = "yellow") +
