...
celldata[which(celldata$anncluster == "06"), "anncluster"] = "06_Dendritic cells"# DC +Mac
# not sure, surround the tumour edge , a lot , have CD 11c and MHC II expression. A little bit CD68+ ,but F480-. so now i think it is DC population
...
celldata[which(celldata$anncluster == "11"), "anncluster"] = "11_Tumour"# not able to check F480 and EpCAm AND pecam in some images,  very small population maybe , but no F480 in3310
...
celldata[which(celldata$anncluster == "16"), "anncluster"] = "16_Uncertain"# check later ..if small population , uncertain 
celldata[which(celldata$anncluster == "17"), "anncluster"] = "17_Uncertain"#need to check other images, mainly CD11band F480  
...
celldata[which(celldata$anncluster == "31"), "anncluster"] = "31_Uncertain"#CD11c +  need to check others 
