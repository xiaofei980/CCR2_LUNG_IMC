...
celldata = read.csv(file.path(INPUT_PATH, "250107_normalised_concatenated_scaled_data_001threshold.csv"),
                    stringsAsFactors = F)
...
tSNE_results = Rtsne(celldata_sampled[,tSNEcolumns], num_threads = 4,
...
output_file <- paste0(OUTPUT_PATH, date, "_celldata_subsamples.csv")
output_file2 <- paste0(OUTPUT_PATH, date, "_tSNE_subsamples.csv")
