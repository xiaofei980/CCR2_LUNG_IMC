...
celldata = read.csv(paste0(INPUT_PATH, "/250116_celldata.csv"))
...
ggplot(celldata, aes(x= Location_Center_X, y = -Location_Center_Y)) +
  ...
  geom_point(data = celldata[which(celldata$MI_TIM3>=0.8),], size = 0.01, colour = "yellow") +
  theme_classic() +
...
ROI13<-subset(celldata, ROI_ID == "06_WT") #   [1] "01_CCR2KO" "02_CCR2KO" "03_CCR2KO" "04_CCR2KO" "05_CCR2KO" "06_WT"     "07_WT"     "08_WT"     "09_WT"    "10_WT"     "11_WT"  
ggplot(ROI13, aes(x= Location_Center_X, y = -Location_Center_Y)) +
  ...
  geom_point(data = ROI13[which(ROI13$MI_TIM3>=0.8),], size = 0.5, colour = "red")+
